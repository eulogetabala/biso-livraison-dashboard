...
function getFragmentQueryDocument(document, fragmentName) {
  ...
  if (typeof actualFragmentName === "undefined") {
    invariant2(fragments.length === 1, 113, fragments.length);
...
function getFragmentFromSelection(selection, fragmentMap) {
  switch (selection.kind) {
    ...
    case "FragmentSpread": {
      ...
      invariant2(fragment, 114, fragmentName);
...
function checkDocument(doc) {
  invariant2(doc && doc.kind === "Document", 115);
  ...
  invariant2(operations.length <= 1, 117, operations.length);
  return doc;
}
...
function getQueryDefinition(doc) {
  ...
  invariant2(queryDef && queryDef.operation === "query", 118);
  return queryDef;
}
function getFragmentDefinition(doc) {
  invariant2(doc.kind === "Document", 119);
  invariant2(doc.definitions.length <= 1, 120);
  var fragmentDef = doc.definitions[0];
  invariant2(fragmentDef.kind === "FragmentDefinition", 121);
  return fragmentDef;
}
      ...
      if (this.cached) {
        ...
        this.performWork = wrap3(DocumentTransform2.prototype.performWork.bind(this), {
          makeCacheKey: function(document) {
            ...
            if (cacheKeys) {
              invariant2(Array.isArray(cacheKeys), 104);
...
function shouldInclude(_a3, variables) {
  ...
  return getInclusionDirectives(directives).every(function(_a4) {
    ...
    if (ifArgument.value.kind === "Variable") {
      ...
      invariant2(evaledValue !== void 0, 105, directive.name.value);
    } else {
...
function getInclusionDirectives(directives) {
  ...
  if (directives && directives.length) {
    directives.forEach(function(directive) {
      ...
      invariant2(directiveArguments && directiveArguments.length === 1, 106, directiveName);
      var ifArgument = directiveArguments[0];
      invariant2(ifArgument.name && ifArgument.name.value === "if", 107, directiveName);
      var ifValue = ifArgument.value;
      invariant2(ifValue && (ifValue.kind === "Variable" || ifValue.kind === "BooleanValue"), 108, directiveName);
  ...
  if (globalThis.__DEV__ !== false) {
    if (modeArg) {
      if (modeArg.value.kind === Kind.VARIABLE) {
        globalThis.__DEV__ !== false && invariant2.warn(109);
      } else if (modeArg.value.kind !== Kind.STRING) {
        globalThis.__DEV__ !== false && invariant2.warn(110);
      } else if (modeArg.value.value !== "migrate") {
        globalThis.__DEV__ !== false && invariant2.warn(111, modeArg.value.value);
      }
    }
  }
...
function removeDirectivesFromDocument(directives, doc) {
  ...
  var getInUse = function(ancestors) {
    ...
    globalThis.__DEV__ !== false && invariant2.error(124);
    return null;
  };
...
function warnRemovedOption(options, name, callSite, recommendation) {
  ...
  warnDeprecated(name, function() {
    if (name in options) {
      globalThis.__DEV__ !== false && invariant2.warn(103, callSite, name, recommendation);
    }
  });
}
...
//# sourceMappingURL=chunk-ZVHHK4T5.js.map
