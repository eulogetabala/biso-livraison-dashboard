...
function getAccessorWarningDescriptor(fieldName, value, path, operationName2, operationType) {
  var getValue = function() {
    ...
    globalThis.__DEV__ !== false && invariant.warn(60, operationName2 ? "".concat(operationType, " '").concat(operationName2, "'") : "anonymous ".concat(operationType), "".concat(path, ".").concat(fieldName).replace(/^\./, ""));
    getValue = function() {
      return value;
    };
    return value;
...
var ApolloClient = (
  ...
  (function() {
    ...
    ApolloClient2.prototype.watchFragment = function(options) {
      var _a;
      return this.cache.watchFragment(__assign(__assign({}, options), (_a = {}, _a[/* @__PURE__ */ Symbol.for("apollo.dataMasking")] = this.queryManager.dataMasking, _a)));
    };
...
function parser(document) {
  ...
  invariant(!fragments.length || queries.length || mutations.length || subscriptions.length, 95);
  invariant(
...
function useInternalState(client, query, options, renderPromises, makeWatchQueryOptions) {
  ...
  var _a = React12.useState(createInternalState), internalState = _a[0], updateInternalState = _a[1];
...
function useLazyQuery(query, options) {
  ...
  var result = React13.useMemo(function() {
  ...
  var execute2 = React13.useCallback(function(executeOptions) {
    if (globalThis.__DEV__ !== false) {
      ...
      for (var _a2 = 0, DEPRECATED_EXECUTE_OPTIONS_1 = DEPRECATED_EXECUTE_OPTIONS; _a2 < DEPRECATED_EXECUTE_OPTIONS_1.length; _a2++) {
        var name_2 = DEPRECATED_EXECUTE_OPTIONS_1[_a2];
  ...
  var executeRef = React13.useRef(execute2);
...
function useMutation(mutation, options) {
  ...
  var execute2 = React14.useCallback(function(executeOptions) {
...
function useSubscription(subscription, options) {
  ...
  var _a = React15.useState(options.skip ? null : recreate), observable = _a[0], setObservable = _a[1];
...
function useSuspenseFragment_(options) {
  ...
  var _a = React20.useState(fragmentRef === null ? NULL_PLACEHOLDER : [fragmentRef.key, fragmentRef.promise]), current = _a[0], setPromise = _a[1];
...
function useQueryRefHandlers_(queryRef) {
  assertWrappedQueryRef(queryRef);
  var _a = React22.useState(queryRef), previousQueryRef = _a[0], setPreviousQueryRef = _a[1];
